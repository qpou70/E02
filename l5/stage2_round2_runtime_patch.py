...
new = "p16=render_crop(16,(36,166,756,532),'round2_p16_original_bonding_diagrams.png',300,True)"
if old not in s:
    raise RuntimeError('ROUND2 p16 crop target not found')
p.write_text(s.replace(old, new), encoding='utf-8')
print('ROUND2 p16 crop starts below the orange title-rule fragment')
