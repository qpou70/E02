...
ROOT=Path('l5')
REVIEW=ROOT/'stage2_visual_review'
NEWPDF=REVIEW/'new_pdf'
ORIG=ROOT/'stage1_source_reference/ECE340_L5_S18_Posted.pdf'
PPT=ROOT/'ECE340_L5_S18_Posted_中文忠实重建_第二阶段返修_第8_10_11_14_16_17_19_22_24页.pptx'
...
for p in TARGET:
    ...
    d=ImageDraw.Draw(can); d.text((12,18),f'Original PDF page {p}',fill=(0,0,0)); d.text((a.width+gap+12,18),f'New Stage 2 page {p}',fill=(0,0,0))
    can.save(COMP/f'page_{p:02d}_original_pdf_vs_new.jpg',quality=91); ot.unlink()
...
sheet.save(REVIEW/'contact_sheet_stage2_pages_08_10_11_14_16_17_19_22_24.jpg',quality=91)
small=sheet.copy(); small.thumbnail((720,500)); small.save(PRE/'contact_sheet_stage2_tiny.jpg',quality=45,optimize=True)
...
print('stage2 evidence complete')
